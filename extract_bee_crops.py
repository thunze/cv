    ...
    for root, dirs, files in os.walk(trajectories_path):
        for file in files:
            if file.endswith('.txt'):
                rec_no = root[-1]  # or extract recording_no appropriately
            ...
            if file.endswith('.mp4'):
                ...
                if os.path.isdir(frames_path + "rec" + rec_no):
                    ...
                    while success:
                        ...
                        cv2.imwrite(f"{frames_path}/rec{rec_no}/frame%04d.png" % count, image)  # save frame as JPEG file
                        count += 1
...
def main():
    ...
    extract_save_crops(bee_detections_by_frame, frames_path,crops_path ,"000022")
